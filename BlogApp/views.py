...
def post_list_view(request):
    ...
    return render(request,'BlogApp/post_list.html',{"post_list":post_list,'comments':comments,'csubmit':csubmit,'similar_posts':similar_posts})
...
#send_mail('Hello', 'Very imp msg....','sandhyaarrolla5@gmail.com',['sandhyaarrolla66@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'sandhyaarrolla5@gmail.com', [cd['to']]) #use[] or ()tuple
            sent=True;
    else:
	    form=EmailSendForm()
